...
func (s *Server) RegisterHandlerFromEndpoint() {
	...
	// register endpoint...
	v1.RegisterAdministratorServiceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
	v1.RegisterRoleServiceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
	v1.RegisterPermissionServiceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
	v1.RegisterNavMenuServiceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
}
