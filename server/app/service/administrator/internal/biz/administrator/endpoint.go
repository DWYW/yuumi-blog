...
func MakeGetAdministratorsEndpoint(s ServiceInterface) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		r, _ := request.(*v1.GetAdministratorsRequest)
		return s.GetAdministrators(ctx, r)
	}
}

func MakeGetAdministratorWithNameAndPasswordEndpoint(s ServiceInterface) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		r, _ := request.(*v1.GetAdministratorWithNameAndPasswordRequest)
		return s.GetAdministratorWithNameAndPassword(ctx, r)
	}
}
