...
func (model *Model) CreateOne(ctx context.Context, v *schema.Role) (*schema.Role, error) {
...
func (model *Model) DeleteOne(ctx context.Context, condition *DeleteCondition) (*schema.Role, error) {
	dest := schema.Role{}
