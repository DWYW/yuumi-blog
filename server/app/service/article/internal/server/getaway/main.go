...
func (s *Server) RegisterHandlerFromEndpoint() {
	...
	// register endpoint...
	v1.RegisterArticleServiceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
	v1.RegisterVisitorServiceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
	v1.RegisterCommentServiceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
}
