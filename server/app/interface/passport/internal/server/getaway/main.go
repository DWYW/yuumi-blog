	...
	s.mux = runtime.NewServeMux(
		runtime.WithMetadata(func(ctx context.Context, request *http.Request) metadata.MD {
			md := metadata.Pairs(
				...
				"request-id", request.Header.Get("request-id"),
			)
...
func (s *Server) RegisterHandlerFromEndpoint() {
	...
	// register endpoint...
	v1.RegisterAuthenticateInterfaceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
	v1.RegisterAuthorizeInterfaceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
	v1.RegisterGithubInterfaceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
}
