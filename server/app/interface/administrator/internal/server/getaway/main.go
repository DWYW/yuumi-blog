...
func (s *Server) RegisterHandlerFromEndpoint() {
	...
	// register endpoint...
	v1.RegisterAdministratorInterfaceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
	v1.RegisterPermissionInterfaceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
	v1.RegisterRoleInterfaceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
	v1.RegisterNavMenuInterfaceHandlerFromEndpoint(s.context, s.mux, s.GrpcAddr, opts)
}
